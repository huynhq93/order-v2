<template>
  <div class="shipping-code-view">
    <!-- Navigation Menu -->
    <NavigationMenu active-menu-item="order-codes" />

    <MonthSelector v-model="selectedDate" @update:model-value="handleDateChange" class="mb-6" />

    <ShippingCodeManager :selected-date="selectedDate" @updated="handleOrderUpdated" />
  </div>
</template>
